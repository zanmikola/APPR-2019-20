...
-`Leto` - spremenljivka: leto meritve(2010-2017)
  ...
  - `Namen` - spremenljivka: namen za kaj se je investiralo
  - `Investicije` - meritev: tisoč € investirano

3. 'evropa' - podatki o izpustih toplogrednih plinov v Evropi
-`Leto` - spremenljivka: leto meritve(2010-2017)
  - `Drzava` - spremenljivka: ime evropske države
  - `Tisoc_ton` - meritev: količina (v tisoš tonah) izpuščenih toplogrednih plinov
