...
okoljske_investicije$`Investicije mio €` <- as.numeric(okoljske_investicije$'Investicije mio €')
...
bdp <- gather(bdp, 'Leto', 'Proizvodnja mio €', 2:9)
...
zdruzena_tabela$'Izpusti (Mg)' <- rowSums(zdruzena_tabela[3:6])
